...
function cardAnimation() {
    ...
    productDetails(gift_id);
    customizedGift(gift_id);
...
function wrapperCompleteHandler(e) {
    if (e.target.responseText == 'success') {
        ...
        $('#go-to-accessories').click(function(e) {
            ...
            window.location.href = `http://localhost/targets/details.php?id=${gift_id}#pills-accessories`;
        });
    } else {
        $('.upload-progress-modal').modal('hide');
        iziToast.warning({
...
function subtractFromCart(gift_id) {
    ...
    if (gift_quantity > 1) {
        // New gift item quantity
        gift_quantity = gift_quantity - 1;
        $.ajax({
            url: '/subtract_item',
            method: 'post',
            data: {
