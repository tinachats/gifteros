...
$(function() {
    ...
    $(document).on('click', '.visitor-wishes', function() {
        ...
        $('#wishlist-modal-signin').attr('href', 'index.php?redirect=details.php?id=' + gift_id);
        $('#wishlist-modal-signup').attr('href', 'signup.php?redirect=details.php?id=' + gift_id);
    });
...
// Fetch all homepage gift items
function homepageGifts() {
    let action = 'shop';
    $.ajax({
        url: '/shop',
        method: 'get',
        ...
        dataType: 'json',
        beforeSend: productsPreloader(),
        success: function(data) {
            $('#gift-categories').html(data.gift_categories);
            $('#customizable-gifts').html(data.customized_gifts);
            $('#kitchenware').html(data.kitchenware);
            $('#personal-care').html(data.personal_care);
            $('#plasticware').html(data.plasticware);
            $('#combos').html(data.combo_gifts);
...
// Product Preloader
function productsPreloader(limit = 4) {
    var output = '';
