    ...
    $(document).on('click', '.add-to-cart-btn', function(e) {
        ...
        if (category === 'customizable') {
            ...
            $(document).on('click', '#customize-signup-btn', function(e) {
                e.preventDefault();
                e.stopPropagation();
                window.location.href = 'signup.php?redirect=details.php?id=' + gift_idgif
            });
            ...
            $('#cart-options' + gift_id).removeClass('d-none');
            addToCart(gift_id, gift_name, gift_image, usd_price, zar_price, zwl_price, sale_usd_price,
                sale_zar_price, sale_zwl_price, sale_end_time, gift_quantity, gift_units, category_name);
            addIntoBox();
        }
    });
    /*** /.Add-to-Cart Functions ***/
...
function addToCart(product_id, product_name, product_image, usd_price, zar_price, zwl_price, sale_usd_price,
    sale_zar_price, sale_zwl_price, sale_end_time, product_quantity, product_units, category_name) {
    var action = 'add-item';
    if (product_quantity > 0) {
        $.ajax({
            ...
            data: {
                ...
                zar_price: zar_price,
                zwl_price: zwl_price,
                sale_usd_price: sale_usd_price,
                sale_zar_price: sale_zar_price,
                sale_zwl_price: sale_zwl_price,
...
function subtractFromCart(product_id, product_quantity) {
