...
<!-- Header -->
<header class="header fixed-top" id="web-main-header">
    <!-- Navbar -->
            ...
            @guest
                ...
                <li class="nav-item dropdown ml-3">
                    <div class="d-flex align-items-center d-cursor font-600 dropdown-toggle text-color-switch" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Toggle Sign-in Form">
                        ...
                        <span class="ml-1 text-color-switch">Account</span>
                    </div>
    ...
    <!-- Search Form -->
    <form method="get" action="/search" id="search-form" class="bg-whitesmoke d-none d-md-block">
        {{ csrf_field() }}
