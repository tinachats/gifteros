    ...
    @if(count($customized_gifts) > 0)
        ...
        <div class="d-flex justify-content-between align-items-center title mt-3">
            ...
            <div class="d-flex justify-content-around align-items-center">
                ...
                <a role="button" href="/category/customizable" class="btn btn-sm btn-outline-dark rounded-0" id="all-customizable">
    ...
    @if(count($kitchenware) > 0)
        ...
        <div class="d-flex justify-content-between align-items-center title mt-3">
            ...
            <div class="d-flex justify-content-around align-items-center">
                <i role="button" class="material-icons view-option grid-icon active" data-view="grid-view" title="Grid View">view_comfy</i>
                <i role="button" class="material-icons view-option list-icon mx-3" data-view="list-view" title="List view">view_list</i>
                <a role="button" href="/category/kitchenware" class="btn btn-sm btn-outline-dark rounded-0" id="kitchenware">
                    <span class="text-dark-inverse">View all</span>
                    <i class="ion ion-chevron-right text-dark-inverse ml-2"></i>
                </a>
            </div>
    ...
    @if(count($plasticware) > 0)
        ...
        <div class="d-flex justify-content-between align-items-center title mt-3">
            ...
            <div class="d-flex justify-content-around align-items-center">
                <i role="button" class="material-icons view-option grid-icon active" data-view="grid-view" title="Grid View">view_comfy</i>
                <i role="button" class="material-icons view-option list-icon mx-3" data-view="list-view" title="List view">view_list</i>
                <a role="button" href="/category/plasticware" class="btn btn-sm btn-outline-dark rounded-0" id="plasticware">
                    <span class="text-dark-inverse">View all</span>
                    <i class="ion ion-chevron-right text-dark-inverse ml-2"></i>
                </a>
            </div>
    ...
    @if(count($combo_gifts) > 0)
        ...
        <div class="d-flex justify-content-between align-items-center title mt-3">
            ...
            <div class="d-flex justify-content-around align-items-center">
                <i role="button" class="material-icons view-option grid-icon active" data-view="grid-view" title="Grid View">view_comfy</i>
                <i role="button" class="material-icons view-option list-icon mx-3" data-view="list-view" title="List view">view_list</i>
                <a role="button" href="/category/combo_gifts" class="btn btn-sm btn-outline-dark rounded-0" id="combo-gifts">
                    <span class="text-dark-inverse">View all</span>
                    <i class="ion ion-chevron-right text-dark-inverse ml-2"></i>
                </a>
            </div>
    ...
    @if(count($appliances) > 0)
        ...
        <div class="d-flex justify-content-between align-items-center title mt-3">
            ...
            <div class="d-flex justify-content-around align-items-center">
                <i role="button" class="material-icons view-option grid-icon active" data-view="grid-view" title="Grid View">view_comfy</i>
                <i role="button" class="material-icons view-option list-icon mx-3" data-view="list-view" title="List view">view_list</i>
                <a role="button" href="/category/appliances" class="btn btn-sm btn-outline-dark rounded-0" id="appliances">
                    <span class="text-dark-inverse">View all</span>
                    <i class="ion ion-chevron-right text-dark-inverse ml-2"></i>
                </a>
            </div>
